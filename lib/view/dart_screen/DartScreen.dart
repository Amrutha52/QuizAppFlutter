...
class _DartScreenState extends State<DartScreen> {
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "${currentQstnIndex + 1}/${DummyDb.dartquestions.length}",
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      DummyDb.dartquestions[currentQstnIndex]["question"].toString(),
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 20,
                  ...
                  Column(
                    children: List.generate(
                      4,
                          (index) {
                        List ansOptions =
                        DummyDb.dartquestions[currentQstnIndex]["options"] as List;
                        return optionsCard(
                          ...
                          onOpitonsTapped: () {
                            if (selectedIndex == null)
                            {
                              ...
                              setState(() {});
                              if (selectedIndex ==
                                  DummyDb.dartquestions[currentQstnIndex]
                                  ["answerIndex"])
                              {
                                rightAnswerCount ++;
                  ...
                  InkWell(
                    onTap: () {
                      if (selectedIndex != null)
                      {
                        if (currentQstnIndex < DummyDb.dartquestions.length - 1)
                        {
                          currentQstnIndex++;
  ...
  Color getColor(int index) {
    if (selectedIndex != null) {
      if (DummyDb.dartquestions[currentQstnIndex]["answerIndex"] == selectedIndex &&
          index == selectedIndex) {
        return Colors.green;
      } else if (DummyDb.dartquestions[currentQstnIndex]["answerIndex"] !=
          selectedIndex &&
          index == selectedIndex) {
        return Colors.red;
      } else if (DummyDb.dartquestions[currentQstnIndex]["answerIndex"] == index) {
        return Colors.green;
      }
    }
