...
class _GamesScreenState extends State<GamesScreen> {
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "${currentQstnIndex + 1}/${DummyDb.gamesquestions.length}",
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      DummyDb.gamesquestions[currentQstnIndex]["question"].toString(),
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 20,
                  ...
                  Column(
                    children: List.generate(
                      4,
                          (index) {
                        List ansOptions =
                        DummyDb.gamesquestions[currentQstnIndex]["options"] as List;
                        return optionsCard(
                          ...
                          onOpitonsTapped: () {
                            if (selectedIndex == null)
                            {
                              ...
                              setState(() {});
                              if (selectedIndex ==
                                  DummyDb.gamesquestions[currentQstnIndex]
                                  ["answerIndex"])
                              {
                                rightAnswerCount ++;
                  ...
                  InkWell(
                    onTap: () {
                      if (selectedIndex != null)
                      {
                        if (currentQstnIndex < DummyDb.gamesquestions.length - 1)
                        {
                          currentQstnIndex++;
  ...
  Color getColor(int index) {
    if (selectedIndex != null) {
      if (DummyDb.gamesquestions[currentQstnIndex]["answerIndex"] == selectedIndex &&
          index == selectedIndex) {
        return Colors.green;
      } else if (DummyDb.gamesquestions[currentQstnIndex]["answerIndex"] !=
          selectedIndex &&
          index == selectedIndex) {
        return Colors.red;
      } else if (DummyDb.gamesquestions[currentQstnIndex]["answerIndex"] == index) {
        return Colors.green;
      }
    }
